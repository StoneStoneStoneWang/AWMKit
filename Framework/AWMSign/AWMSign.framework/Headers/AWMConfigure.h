...
typedef NS_ENUM(NSInteger ,AWMConfigureType) {
    /** 花店  */
    AWMConfigureTypeFlower NS_SWIFT_NAME(flower) = 1,
};

NS_ASSUME_NONNULL_BEGIN

@interface AWMConfigure : NSObject
